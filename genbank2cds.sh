...
genbank2gff=$CWD/scripts/genbank2gff.rb
extractGenomeFromGenbank=$CWD/scripts/extractGenomeFromGenbank.rb
gff2fasta=$CWD/scripts/gff2fasta.pl
translate_seq=$CWD/scripts/translate_seq.rb
